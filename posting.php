...
<div class="wrapper">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="posting.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Bond Postings</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><b>Information of Postings</b></h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Student Posting</li>
              <li class="breadcrumb-item active">Bond Posting</li>
            </ol>
 ...
 <tbody>
  ...
  echo 
  "<tr><td>" . $row["student_name"] . "</td><td>"
  . $row["place"] . "<td>" ; echo "Uttarakhand";
  }
  echo "</table>";
  } else { echo "0 results"; }
  ?> 
