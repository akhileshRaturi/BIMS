...
if(isset($_POST['submit'])){
   $student_roll = $_POST['student_roll'];
    $sql ="DELETE FROM `registeration` WHERE `student_roll`='$student_roll'";
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
           ...
           <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="delete.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Delete User</p>
                </a>
              </li>
              ...
              <form role="form" action="delete.php" method="post" >
                <div class="card-body">
                    <div class="form-group">
                      ...
                      <input name="student_roll" type="text" class="form-control" placeholder="Roll No" style="width: 50%;">
                    </div>
                    <div class="form-group">
                    </div>
                  </div>
