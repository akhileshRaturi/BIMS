...
$datediffA = abs(round(($toDate- $fromDate) / (60 * 60 * 24)));
//days between From and Current
$datediffB =  abs(round(($currentDate- $fromDate) / (60 * 60 * 24)));
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="sidebar">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="userbond.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0 text-dark">Bond Information </h1>
              </div><!-- /.col -->
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="userdash.php">Home</a></li>
        <li class="breadcrumb-item active">Information</li>
        <li class="breadcrumb-item active">Bond Information</li>
                </ol>
              </div><!-- /.col -->
            </div><!-- /.row -->
          </div><!-- /.container-fluid -->
          ...
          <div class="card" >
            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                <thead  style="background-color:#80b3ff;">
                <tr>
                  <th>Roll No</th>
                  <th>Name</th>
                  <th>Bond Place</th>
 ...
 <tbody>
  ...
  while($row = $result->fetch_assoc()) {
    ...
    $bondplace=$row['place'];
  echo 
  "<tr><td>" . $row["student_roll"]. "</td><td>" . $row["student_name"] . "</td><td>"
  . $row["place"] . "</td><td>". $new_date . "</td><td>" . $neww . "</td>" ;
  }
  echo "</table>";
  } else { echo "0 results"; }
  ?> 
...
<br><br><br><br>
          <div class="col-10">
            <div class="info-box bg-info" style="font-size: large;">
              <span class="info-box-icon"><i class="fas fa-car"></i></span>

              <div class="info-box-content" style="font-size: large;">
                <span class="info-box-text"><b>Progress</b></span>
               

                <div class="progress" style="font-size: large;">
                  <div class="progress-bar" style="width: <?php echo"".$percentage?>%;">%</div>
                </div>
                <span class="progress-description">
                  <?php echo "".$percentage?>% &nbsp;&nbsp;Bond Period Completed
                </span>
              </div>
              <!-- /.info-box-content -->
            </div>
